...
class PromotionService {
    ...
    getExhaustedPromotionIds(ctx: RequestContext, promotions: Promotion[], customerId?: ID) => Promise<Set<ID>>;
}
```
...
<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, promotions: <a href='/reference/typescript-api/entities/promotion#promotion'>Promotion</a>[], customerId?: <a href='/reference/typescript-api/common/id#id'>ID</a>) => Promise<Set<<a href='/reference/typescript-api/common/id#id'>ID</a>>>`}   />
